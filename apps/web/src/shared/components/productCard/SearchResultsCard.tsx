      ...
      <div className="flex gap-3">
        ...
        <div className="flex flex-col gap-1">
          <div>
            ...
            <h2 className="body2-m text-grey-black line-clamp-2 leading-snug">
              {product.productName}
            </h2>
          </div>
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-1">
              ...
              <div
                ...
                aria-label={`리뷰한 크리에이터: ${product.creators.map((c) => c.name).join(', ')}`}
              >
                {[...product.creators].reverse().map((creator, index, arr) => (
                  <div
                    key={creator.name}
                    className="relative size-5 overflow-hidden rounded-full border border-white"
