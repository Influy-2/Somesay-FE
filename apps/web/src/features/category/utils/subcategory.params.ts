...
const DEFAULT_SORT_TYPE: ProductSortType = 'RATING';
const SORT_TYPES: ProductSortType[] = ['RATING', 'REVIEW', 'PRICE'];

// URL은 사용자가 고칠 수 있으므로 계약에 없는 값이면 기본 정렬로 되돌립니다.
export const getProductSort = (value: string | null): ProductSortType =>
